...
<html>
<head>
	<title>Welcome to Guimaras Product and Souvenir Online Retail</title>
		...
		<div class="row">
			<div class="col-lg-3 col-sm-3" id="myScrollspy">
			  <div data-spy="affix" data-offset-top="70">	
				...
				<a href="gm-signup.php" class="btn btn-info btn-lg btn-block">Create Account <i class="fa fa-edit fa-fw"></i></a>
				<a href="gm-login.php" class="btn btn-info btn-lg btn-block">Log In <i class="fa fa-sign-in-alt fa-fw"></i></a>
			  </div> 	
			</div>
