...
<html>
<head>
	<title>Profile &bull; Guimaras Product and Souvenir Online Retail</title>
...
<div class="container" style="margin-top: 50px; margin-bottom: 75px;">
	...
	<div class="row">
		...
		<div class="col-lg-9 col-sm-9">
			<button class="btn btn-info btn-lg pull-right" data-toggle="modal" data-target="#modal-editprofile"><i class="fa fa-edit fa-fw"></i> Edit Profile</button>
			...
			<?php
				...
				<form class="row" id="d-detail-form" method="POST">
					...
					<div class="form-group col-lg-6 col-sm-6">
					    ...
					    <input type="text" class="form-control input-lg" name="mobile" value="<?=$del_row['mobile_number'];?>">
				    </div>
					<div class="form-group col-lg-6 col-sm-6">
						<label>Telephone Number:</label>
					    <input type="text" class="form-control input-lg" name="telephone" value="<?=$del_row['telephone_number'];?>">
					</div>
					<div class="form-group col-lg-6 col-sm-6">
						<label>Address:</label>
						<textarea class="form-control input-lg" name="address"><?=$del_row['address'];?></textarea>
					</div>
					<div class="form-group col-lg-6 col-sm-6">
						<label>Address Details:</label>
						<textarea class="form-control input-lg" name="address_details"><?=$del_row['address_details'];?></textarea>
					</div>
					<div class="form-group col-lg-12 col-sm-12">
						<button type="submit" class="btn btn-danger btn-lg" onclick="form_process ('d-detail-form', '../functions/save-delivery-details.php', 'd-detail-response')">Update</button>
					</div>
				</form>
				</span>
				<?php	
				...
				<form class="row" id="d-detail-form" method="POST">
					...
					<div class="form-group col-lg-6 col-sm-6">
						<label>Address Details:</label>
						<textarea class="form-control input-lg" name="address_details"></textarea>
					</div>
					<div class="form-group col-lg-12 col-sm-12">
						<button type="submit" class="btn btn-danger btn-lg" onclick="form_process ('d-detail-form', '../functions/save-delivery-details.php', 'd-detail-response')">Save</button>
					</div>
				</form>
				</span>
				<?php	
