				...
				<div class="panel-group" id="accordion">
				  <div class="panel panel-info">
				    <div class="panel-heading">
				      <button data-toggle="collapse" data-target="#collapse<?=$order_row['order_id'];?>" class="btn btn-lg  btn-info pull-right margin-top">View Details <i class="fa fa-chevron-down fa-fw"></i></button>
