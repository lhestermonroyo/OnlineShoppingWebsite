...
<html>
<head>
	<title>Checkouts &bull; Guimaras Product and Souvenir Online Retail</title>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php
							...
							?>
							<button class="btn btn-lg btn-info btn-block" onclick="load_process('checkout-response', '../functions/save-order.php?acc_id=<?=$cos_row['acc_id'];?>&payment_type=COD')">Cash on Delivery <i class="fa fa-truck fa-fw"></i></button>
							<button class="btn btn-lg btn-info btn-block" onclick="window.location.assign('../../www.paypal.com')">PayPal <i class="fa fa-credit-card fa-fw"></i></button>
							<?php	
							}
							else if ($del_row['acc_id'] != $cos_row['acc_id']) {
							?>
							<button class="btn btn-lg btn-info btn-block disabled">Cash on Delivery <i class="fa fa-truck fa-fw"></i></button>
							<button class="btn btn-lg btn-info btn-block disabled">PayPal <i class="fa fa-paypal fa-fw"></i></button>
							<?php
							}
						?>					
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php
							...
							<a href="cos-profile.php" class="btn btn-lg btn-info">Update Details <i class="fa fa-edit fa-fw"></i></a>
							<?php	
							}
							else if ($del_row['acc_id'] != $cos_row['acc_id']) {
							?>
