	...
	<div class="row">
		...
		?>	
			<div class="input-group search-extended">
				...
				<input type="text" class="form-control input-lg" name="search" placeholder="Search from over <?=$cnt_seller_row['acc_id'];?> sellers..." onkeyup="load_process ('convo-container', '../functions/search-module.php?cos_id=<?=$cos_row['acc_id'];?>&search-convo='+this.value)" autocomplete="off">
			</div>
			<hr>
