...
<html>
<head>
	<title>Seller Orders &bull; Guimaras Product and Souvenir Online Retail</title>
...
<body>
	<div class="container margin-top-lg">
		<a href="seller-records.php" class="btn btn-info btn-lg"><i class="fa fa-arrow-left"></i> Return</a>
		...
		<div class="panel panel-default padding-top-lg padding-bottom-lg margin-top-lg" id="printarea">
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-lg-10">
						<center>
							<img src="../web-images/gm-logo.png" class="img-responsive" style="height: 100px; width: auto;">
							<p class="lead margin-bottom-sm">Guimaras Product and Souvenir Online Retail</p>
						...
						<div style="margin-top: 60px;">
							<p class="text-center padding-top">&copy; Guimaras Product and Souvenir Online Retail 2017</p>
						</div>
					</div>
					<div class="col-lg-1"></div>
				</div>	
