	...
	<div class="container" style="margin-top: 50px; margin-bottom: 75px;">
	    <div class="row margin-top" style="margin-bottom: -12px;">
    		<div class="col-lg-6 col-sm-6">
    			...
    			<a href="seller-printrecord.php" class="btn btn-info btn-lg margin-left pull-left" style="margin-top: 13px;"><i class="fa fa-print fa-fw"></i> Print Order Record</a>
    		</div>
    		<div class="col-lg-6 col-sm-6">	
			</div>	
    	</div>
		...
		<hr>
				...
				?>
		<p class="lead"><strong>TOTAL EARNINGS: P<?php echo number_format($total, 2);?></strong></p>
