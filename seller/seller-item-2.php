...
<?php include "seller-navbar.php";?>
	<div class="container" id="<?=$item_row['item_id'];?>" style="margin-top: 75px; margin-bottom: 50px;">
		<div class="row">
			<div class="col-lg-4 col-sm-4">
				<a href="seller-category.php?cat_id=<?=$item_row['cat_id'];?>" class="btn btn-info btn-lg margin-bottom-lg"><i class="fa fa-arrow-left fa-fw"></i> Return</a>	
			</div>
			<div class="col-lg-8 col-sm-8">	
				<div class="btn-group pull-right">
					<button type="button" data-toggle="modal" data-target="#modal-changequantity" title="Change Quantity" class="btn btn-default btn-lg"><i class="fa fa-plus fa-fw"></i></button>
					<button type="button" data-toggle="modal" data-target="#modal-addfeatures" title="Add Features" class="btn btn-default btn-lg"><i class="fa fa-list fa-fw"></i></button>
					<button type="button" data-toggle="modal" data-target="#modal-edititem" title="Edit" class="btn btn-default btn-lg"><i class="fa fa-edit fa-fw"></i></button>
					<button type="button" data-toggle="modal" data-target="#modal-deleteitem" title="Delete" class="btn btn-default btn-lg"><i class="fa fa-trash fa-fw"></i></button>
				</div>	
			</div>
		</div>
		<?php
