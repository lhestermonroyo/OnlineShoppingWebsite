...
<html>
<head>
	<title>Seller Inventory &bull; Guimaras Product and Souvenir Online Retail</title>
...
<?php include "seller-navbar.php";?>
    <div class="container"  style="margin-top: 50px; margin-bottom: 100px;">
		...
		<ul class="nav nav-pills nav-justified">
			...
			?>
		  	<li class="active"><a href="seller-inventory.php" class="btn-lg">All Items</a></li>
		  <?php
    		...
    		<div class="col-lg-6 col-sm-6">	
				<div class="btn-group pull-right margin-top">
					<div class="input-group search-unextended pull-left">
					    ...
					    <input type="text" class="form-control input-lg" name="search" placeholder="Search item" onkeyup="load_process ('item-container', '../functions/search-module.php?seller_id=<?=$seller_row['acc_id'];?>&search-item-4='+this.value)" autocomplete="off">
					</div>
				</div>	
			</div>	
    	</div>
