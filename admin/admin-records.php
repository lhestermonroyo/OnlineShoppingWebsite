...
<html>
<head>
	<title>Records &bull; Guimaras Product and Souvenir Online Retail</title>
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 75px;">
	    <div class="row margin-top" style="margin-bottom: -12px;">
    		<div class="col-lg-6 col-sm-6">
    			...
    			<a href="admin-printrecord.php" class="btn btn-info btn-lg margin-left pull-left" style="margin-top: 13px;"><i class="fa fa-print fa-fw"></i> Print Order Record</a>
    		</div>
    	</div>
