...
<html>
<head>
	<title>Inventory &bull; Guimaras Product and Souvenir Online Retail</title>
...
<?php include "admin-navbar.php";?>
    <div class="container" style="margin-top: 50px; margin-bottom: 75px;">
		...
		<ul class="nav nav-pills nav-justified">
			...
			?>
		  	<li class="active"><a href="admin-inventory.php" class="btn-lg">All Items</a></li>
		  <?php
    		...
    		<div class="col-lg-6 col-sm-6">	
				<div class="btn-group pull-right margin-top">
					<div class="input-group search-unextended pull-left">
					    ...
					    <input type="text" class="form-control input-lg" name="search" placeholder="Search item..." onkeyup="load_process ('item-container', '../functions/search-module.php?search-item-2='+this.value)" autocomplete="off">
					</div>
				</div>	
			</div>	
    	</div>
