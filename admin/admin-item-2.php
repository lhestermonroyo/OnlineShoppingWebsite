	...
	<div class="container" style="margin-top: 75px; margin-bottom: 75px;">
		<div class="row">
			<div class="col-lg-4 col-sm-4">
				<a href="admin-category.php?cat_id=<?=$item_row['cat_id'];?>" class="btn btn-info btn-lg margin-bottom-lg"><i class="fa fa-arrow-left fa-fw"></i> Return</a>	
			</div>
		</div>
		...
		<div class="row">				
		<?php
			$option_query = $conn->query("select * from items_tbl where cat_id = '".$item_row['cat_id']."' and item_id not in ('".$_GET['item_id']."') order by rand() limit 4");
