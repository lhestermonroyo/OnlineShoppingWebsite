    ...
    <div class="container" style="margin-top: 50px; margin-bottom: 75px;">
		<h2><i class="fa fa-users fa-fw"></i> Accounts</h2>
			...
			<ul class="nav nav-pills nav-justified margin-bottom-lg">
			  ...
			  <li class="active"><a class="btn btn-lg" href="admin-useraccounts.php">User Accounts</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6">	
					<div class="input-group search-unextended pull-left">
					    ...
					    <input type="text" class="form-control input-lg" name="search" placeholder="Search user..." onkeyup="load_process ('user-container', '../functions/search-module.php?search-user='+this.value)" autocomplete="off">
					</div>
				</div>
			</div>
