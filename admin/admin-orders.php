...
<html>
<head>
	<title>Orders &bull; Guimaras Product and Souvenir Online Retail</title>
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 75px;">
		<div class="margin-top row" style="margin-bottom: -12px;">
    		<div class="col-lg-6 col-sm-6">
    			...
    			<button class="btn btn-lg btn-info margin-left pull-left" data-toggle="modal" data-target="#modal-feesettings" style="margin-top: 13px;"><i class="fa fa-money-bill-alt fa-fw"></i> Fee Settings</button>
    		</div>
    		<div class="col-lg-6 col-sm-6">	
				<div class="btn-group pull-right margin-top">
					<div class="input-group search-unextended pull-left">
					    <span class="input-group-addon"><i class="fa fa-search"></i></span>
					    <input type="text" class="form-control input-lg" name="search" placeholder="Search orders..." onkeyup="load_process ('order-container', '../functions/search-module.php?search-order='+this.value)" autocomplete="off">
					</div>
				</div>	
			</div>	
    	</div>
