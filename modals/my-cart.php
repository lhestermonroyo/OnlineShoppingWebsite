              ...
              <div class="panel panel-default">
                <div class="panel-body">
                  <div class="row">
                   ...
                   <div class="col-lg-2 col-lg-2">
                      <button type="submit" style="margin-top: 15px;" class="btn btn-danger btn-lg btn-block" onclick="form_process ('updatecart-form<?=$item_row['item_id'];?>', '../functions/update-cart.php', 'updatecart-response<?=$item_row['item_id'];?>')">Update</button>
