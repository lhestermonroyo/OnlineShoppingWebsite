...
<div id="modal-addtocart<?=$item_row['item_id'];?>" class="modal fade" role="dialog">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <div class="row">
               ...
               <div class="col-lg-2 col-lg-2">
                  <button type="submit" style="margin-top: 35px;" class="btn btn-danger btn-lg btn-block" onclick="form_process ('savecart-form<?=$item_row['item_id'];?>', '../functions/save-cart.php', 'savecart-response<?=$item_row['item_id'];?>')">Add</button>
               </div> 
            </div>
            </div>
          </div>
