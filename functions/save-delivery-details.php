		...
		if ($chk_acc_row['acc_id'] == $_POST['acc_id']) {
			...
			<form class="row" id="d-detail-form" method="POST">
				...
				<div class="form-group col-lg-6 col-sm-6">
				    ...
				    <input type="text" class="form-control input-lg" name="mobile" value="<?=$_POST['mobile'];?>">
			    </div>
				<div class="form-group col-lg-6 col-sm-6">
					<label>Telephone Number:</label>
				    <input type="text" class="form-control input-lg" name="telephone" value="<?=$_POST['telephone'];?>">
				</div>
				<div class="form-group col-lg-6 col-sm-6">
					<label>Address:</label>
					<textarea class="form-control input-lg" name="address"><?=$_POST['address'];?></textarea>
				</div>
				<div class="form-group col-lg-6 col-sm-6">
					<label>Address Details:</label>
					<textarea class="form-control input-lg" name="address_details"><?=$_POST['address_details'];?></textarea>
				</div>
