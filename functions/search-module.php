			...
			<?php
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<a href="cos-message.php?seller_id=<?=$seller_row['acc_id'];?>" class="btn btn-info btn-lg pull-right">Message Seller <i class="fa fa-envelope"></i></a>
					...
					while ($item_row = $item_query->fetch()) {
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<a href="cos-item.php?item_id=<?=$item_row['item_id'];?>" class="btn btn-info btn-lg pull-right" style="margin-top: -32px;">Item Details <i class="fa fa-chevron-right fa-fw"></i></a>
							</div>
						</div>		
						<?php
						}
			    	...
			    	<tr id="<?=$account_row['acc_id'];?>">
			    		...
			    		<td>
			    			<?php
			    				...
			    				?>
			    				<a data-toggle="modal" data-target="#modal-deleteseller<?=$account_row['acc_id'];?>" class="btn btn-info"><i class="fa fa-trash fa-fw"></i> Delete</a>
			    				<?php	
			    				}
			    			?>
			    		</td>
