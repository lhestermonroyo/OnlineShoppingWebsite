...
<html>
<head>
	<title>Create Account &bull; Guimaras Product and Souvenir Online Retail</title>
			  	...
			  	<div class="panel-body">
			          ...
			          <div class="col-lg-6 col-sm-6">
			            <div class="form-group">
			              ...
			              <input type="date" class="form-control input-lg" name="birthdate" required="true">
			            </div>
			          </div>
			          <div class="col-lg-6 col-sm-6">
			            <div class="form-group">
					...
					<hr>
					<p class="lead text-center">Already have an account? <a href="gm-login.php" class="btn btn-info btn-lg">Log In <i class="fa fa-sign-in-alt fa-fw"></i></a></p>
			  	</div>
			  </div>
